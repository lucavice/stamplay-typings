// This file tests the contract defined by the interfaces in stamplay-sdk.d.ts against the examples provided by the Stamplay docs
...
/// <reference path="stamplay-sdk.d.ts" />
